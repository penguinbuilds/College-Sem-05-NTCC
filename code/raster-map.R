# A faceted raster map displaying the annual global temperature anomalies
...
nc_data <- nc_open("../data/gistemp250_GHCNv4.nc")
# { # nolint
#     sink("../data/gistemp250_GHCNv4.txt") # nolint
#     print(nc_data) # nolint
#     sink() # nolint
# }
...
t_anomaly.array <- ncvar_get(nc_data, "tempanomaly") # nolint
dim(t_anomaly.array)

fillvalue <- ncatt_get(nc_data, "tempanomaly", "_FillValue")
t_anomaly.array[t_anomaly.array == fillvalue$value] <- NA # nolint
...
ggsave("../figures/raster-map.png", width = 10, height = 4.5, units = "in")
